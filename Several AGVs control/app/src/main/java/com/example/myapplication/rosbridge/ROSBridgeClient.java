 ...
 * 
 */
package com.example.myapplication.rosbridge;

import com.example.myapplication.Service;
import com.example.myapplication.message.Message;
import com.example.myapplication.ROSClient;
import com.example.myapplication.rosapi.message.*;
import com.example.myapplication.rosbridge.implementation.*;
import com.example.myapplication.rosbridge.operation.*;
import java.lang.reflect.Field;
import com.example.myapplication.message.MessageType;
...
public class ROSBridgeClient extends ROSClient {
    ...
    private String getServiceType(String service) throws InterruptedException {
        Service<com.example.myapplication.rosapi.message.Service, Type> serviceTypeService =
                new Service<com.example.myapplication.rosapi.message.Service, Type>("/rosapi/service_type",
                    com.example.myapplication.rosapi.message.Service.class, Type.class, this);
        return serviceTypeService.callBlocking(new com.example.myapplication.rosapi.message.Service(service)).type;
    }
